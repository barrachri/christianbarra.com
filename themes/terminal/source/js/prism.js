          ...
          i && ((n = (i.className.match(c) || [, ""])[1].toLowerCase()), (r = C.languages[n])),
            ...
            e.parentNode &&
              ...
              /pre/i.test(i.nodeName) &&
                (i.className = i.className.replace(c, "").replace(/\s+/g, " ") + " language-" + n));
    ...
    for (
      ...
      if (
        ...
        p && (m.style.top = p.offsetTop + "px"),
          f && (m.style.height = f.offsetTop - p.offsetTop + f.offsetHeight + "px");
      } else
    ...
    Array.prototype.slice.call(document.querySelectorAll("pre[data-jsonp]")).forEach(function (a) {
      ...
      (f.src = e.href),
        (window[i] = function (t) {
          ...
          null === e
            ? (r.textContent = "Cannot parse response (perhaps you need an adapter function?)")
