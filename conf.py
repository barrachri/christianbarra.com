...
BLOG_DESCRIPTION = "Hi ! My name is Christian and this is my blog, I write about my projects, my travels and a lots of other interesting stuff"
...
#READ_MORE_LINK = '<p class="more"><a href="{link}">...</a></p>'
